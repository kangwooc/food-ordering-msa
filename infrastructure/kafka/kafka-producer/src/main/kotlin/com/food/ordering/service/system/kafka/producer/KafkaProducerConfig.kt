package com.food.ordering.service.system.kafka.producer
...
class KafkaProducerConfig<K: Serializable, V: SpecificRecordBase>(
    ...
    fun producerConfig(): Map<String, Any?> {
        return mapOf(
            ...
            ProducerConfig.BATCH_SIZE_CONFIG to (kafkaProducerConfigData.batchSize?.times(kafkaProducerConfigData.batchSizeBoostFactor
                ?: 1)),
